...
class Ui_format(QtGui.QDialog):
    ...
    def retranslateUi(self, format):
        ...
        self.comboBox.setItemText(0, _translate("format", "50%", None))
        self.comboBox.setItemText(1, _translate("format", "85%", None))
        self.comboBox.setItemText(2, _translate("format", "100%", None))
